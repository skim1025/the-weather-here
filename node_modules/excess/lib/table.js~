...
( function( exports ) {
  ...
  */
  ...
  Ordered.Build( 'table', Table, {
    ...
    _add: function( added, options ) {
      de&&ug( "Table.._add(), added: " + log.s( added ) );
      
      if( ! added.length ) return this;
      
      this.cols = this.columns._fetch_all();
    ...
    _remove: function( removed, options ) {
      de&&ug( "Table.._remove(), removed: " + log.s( removed ) );
    ...
    _update: function( updates, options ) {
      de&&ug( "Table.._update(), updates: " + log.s( updates ) );
